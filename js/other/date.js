 ...
 */
 ...
 function dateEdit(date) {
            ...
            function getMonthName(date){
                var spdate= date.split("-");
                switch (spdate[1]){
                    case "1":{ return spdate[0]+".Január";break;}
                    case "2":{ return spdate[0]+".Február";break;}
                    case "3":{ return spdate[0]+".Március";break;}    
                    case "4":{ return spdate[0]+".Április";break;}
                    case "5":{ return spdate[0]+".Május";break;}
                    case "6":{ return spdate[0]+".Június";break;}
                    case "7":{ return spdate[0]+".Július";break;}
                    case "8":{ return spdate[0]+".Augusztus";break;}
                    case "9":{ return spdate[0]+".Szeptember";break;}
                    case "10":{ return spdate[0]+".Október";break;}
                    case "11":{ return spdate[0]+".November";break;}
                    case "12":{ return spdate[0]+".December";break;}
                    }
            }
