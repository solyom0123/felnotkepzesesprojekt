...
//teacher manage functions
            ...
            function deleteConnectteacherAndCurUnit(){
                ...
                $.post(slink, {
                    ...
                    console.log(data);
                     ...
                     if (data != "error") {
                        value = '<div class="alert alert-success">Sikeres törlés!</div>';


                    } else {
                        value = '<div class="alert alert-danger">Sikertelen törlés!</div>';

                    }
                    linkWithData("teacher_connect_in_form", value, "load", 'tartalom-wrapper');
             ...
             function connectionSend() {
                ...
                $.post(slink, {
                  ...
                  connectionGetWithParameter(value);
                    

                });
            }
             function connectionEdit(id) {
                var name = document.getElementById("form-row-oktato").value;
                var szulnev = document.getElementById("form-row-without").value;
            ...
            function connectionGetWithParameter(value) {
