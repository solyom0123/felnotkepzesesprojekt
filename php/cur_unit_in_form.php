...
<div class="row "><h2 class="col-md-12 h2-default">Tananyagegység felvitele</h2></div>
    ...
    <form >
        ...
        <div class="form-group row">
            <label for="form-row-name" class="col-md-4 col-form-label">Tartalom:</label>
            <div class="col-md-4">
                <input class="form-control-plaintext" name="form-row-name" id="form-row-name" type="text"  placeholder="Tartalom">
            </div> 
        ...
        <div class="form-group row">
            <label for="form-row-name" class="col-md-4 col-form-label">Óraszám:</label>
            <div class="col-md-4">
                <input class="form-control-plaintext" name="form-row-name" id="form-row-name" type="text"  placeholder="Óraszám">
            </div> 
         ...
         <div class="form-group row">
             ...
             <a href="index.php?page=modul_in_form"><input type="submit" name="log-form" class="btn col-md-5 btn option-button" value="Felvitel"></a>
