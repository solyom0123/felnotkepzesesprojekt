...
$pdf->Cell(40, 10, "elmélet/e-learning", "LC", 0);
//$pdf->Cell(20, 10, "e-learning", "LB", 0);
//$pdf->Cell(20, 10, "gyakorlat", "LB", 0);
$pdf->Cell(40, 10, "gyakorlat", "LB", 0);
...
for ($index = 0; $index < count($maintable); $index++) {
    ...
    $pdf->Cell(40, 6, $maintable[$index][1], 1, 0, "", $fill);
    //$pdf->Cell(30, 6, $maintable[$index][2], 1, 0, "", $fill);
    $pdf->Cell(40, 6, $maintable[$index][3], 1, 0, "", $fill);
    //$pdf->Cell(40, 6, $maintable[$index][4], 1, 0, "", $fill);
