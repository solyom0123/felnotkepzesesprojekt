...
function collectDataForScPrint($id) {
    ...
    $sql = "select"
            ...
            . " (select (case when (EXISTS(select mc.grade =0  from exam_table mc where mc.schedule_plan_data_id=" . $id[0] . " and mc.student_id=" . $id[1] . " and mc.schedule_plan_row_id =sc.id))=0 then 'megbukott'  else 'megbukott'  end))  as grade  "
