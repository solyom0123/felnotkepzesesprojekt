...
<form >
    ...
    <div class="col-md-12 list-wrapper ">
        <a href="index.php?page=modul_in_form"><div class="col-md-4 option-button">Kiválasztás</div></a>
        <a href="index.php?page=modul_in_form"><div class="col-md-4 option-button">Új hozzáadása</div></a>
