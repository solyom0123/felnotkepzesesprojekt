...
<script>setElozo('person_cathegory_page')</script>
                        ...
                        <table class="table-default">
                            <tbody>
                                <tr>
                                    ...
                                    <td><div class="span-half-corner-wrapper">
                                            <div onclick="link('teacher_r_list');setElozo('person_cathegory_page')" ><img src="img/szemely2.png" class="img-circle img-circle-zindex-0" alt="bell" width="100" height="100">
                                           </div>
