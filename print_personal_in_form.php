...
<div class="tab">
    <button class="tablinks" onclick="openCity(event, 'edit')" id="defaultOpen">Személyes adatlap</button>
</div>



<div id="edit" class="tabcontent">
     <div class="row "><h2 class="col-md-12 h2-default">Személyes adatlap nyomtatása: </h2></div>
    <div id="alertdiv">
    ...
    <div class="form-group row">
     ...
     <div class="option-button-wrapper form-group row">
       ...
       <!-- <div onclick="missingsend()"  class="btn col-md-5 btn option-button">Elküld</div>-->
        <div onclick="startPrinting(11)" id="buttonSend" class="btn col-md-5 btn option-button">Nyomtatás</div>
