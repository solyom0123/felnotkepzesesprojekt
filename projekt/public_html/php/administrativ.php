                            ...
                            <tbody>
                                <tr>
                                    <td><div class="span-half-corner-wrapper">
                                            <a href="index.php?page=administrativ_course"><img src="img/bell.png" class="img-circle img-circle-zindex-0" alt="bell" width="100" height="100">
                                            <div class="span-half-corner">
                                                <span>Képzéssel kapcsolatos</span>
                                            </div></a>
                                        </div></td>
                                    <td><div class="span-half-corner-wrapper">
                                            <a href="index.php?page=student_list_admin_show_dairy"><img src="img/bell.png" class="img-circle img-circle-zindex-0" alt="bell" width="100" height="100">
                                            <div class="span-half-corner">
                                                <span>Hallgatói igazolás</span>
                                            </div></a>
                                        </div></td>
