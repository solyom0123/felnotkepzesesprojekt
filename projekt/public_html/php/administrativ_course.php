                            ...
                            <tbody>
                                <tr>
                                    <td><div class="span-half-corner-wrapper">
                                            <a href="index.php?page=show_page"><img src="img/bell.png" class="img-circle img-circle-zindex-0" alt="bell" width="100" height="100">
                                            <div class="span-half-corner">
                                                <span>Jelenléti ív</span>
                                            </div></a>
                                        </div></td>
                                    <td><div class="span-half-corner-wrapper">
                                            <a href="index.php?page=student_list_print_license"><img src="img/bell.png" class="img-circle img-circle-zindex-0" alt="bell" width="100" height="100">
                                            <div class="span-half-corner">
                                                <span>Képzési szerződés</span>
                                            </div></a>
                                        </div></td>
