                            ...
                            <tbody>
                                <tr>
                                    <td><div class="span-half-corner-wrapper">
                                            <a href="index.php?page=user_in_form"><img src="img/bell.png" class="img-circle img-circle-zindex-0" alt="bell" width="100" height="100">
                                            <div class="span-half-corner">
                                                <span>Diákok és oktatók</span>
                                            </div></a>
                                        </div></td>
                                    <td><div class="span-half-corner-wrapper">
                                            <a href="index.php?page=course_basic_datas"><img src="img/bell.png" class="img-circle img-circle-zindex-0" alt="bell" width="100" height="100">
                                            <div class="span-half-corner">
                                                <span>Képzések</span>
                                            </div></a>
                                        </div></td>
