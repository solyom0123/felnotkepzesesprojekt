...
<form class="form-wrapper">
    ...
    <div class="option-button-wrapper">
        <a href="index.php?page=administrativ"><div class="option-button">Jelenléti nyomtatása</div></a>
        <a href="index.php?page=administrativ"><div class="option-button">Mégse</div></a>
